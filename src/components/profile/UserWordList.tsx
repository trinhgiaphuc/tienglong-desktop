  ...
  return (
    <article>
      <input
        ...
        className="w-full text-sm bg-white shadow rounded-lg mb-6 p-4 border border-transparent appearance-none rounded-tg outline-none placeholder-gray-400"
      />
      ...
      <div className="bg-gray-100 dark:bg-gray-700 shadow rounded-lg mb-6">
        ...
        <div className="flex justify-start mb-4 border-t border-gray-100">
          ...
          <div className="flex justify-end w-full mt-1 pt-2 pr-5"></div>
        </div>
